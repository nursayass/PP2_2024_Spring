...
class Fruit(GameObject):
    ...
    def __init__(self):
        ...
        self.image = pygame.transform.scale(pygame.image.load(os.path.abspath(
            f"pp2/tsis9/s_assets/{Constants.fruits[self.weight]}.png")).convert_alpha(),
                                            (cell_size, cell_size))
...
class Game:
    ...
    def drawPlayBtn(self):
        restartImg = pygame.image.load(os.path.abspath("pp2/tsis9/s_assets/restart.png")).convert_alpha()
