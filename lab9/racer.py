...
background = pygame.image.load("lab9/assets/AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("lab9/assets/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("lab9/assets/Player.png")
        self.rect = self.image.get_rect()
...
#Numbers coins
for i in range(2):
    c1 = Coin('lab9/assets/coin2.png', 1)
    coins_group.add(c1)
    all_sprites.add(c1)
for i in range(1):
    c2 = Coin('lab9/assets/coin.png', 2)
    coins_group.add(c2)
    all_sprites.add(c2)
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
          pygame.mixer.Sound('lab9/assets/crash.wav').play()
          time.sleep(1)
