...
blue_image = pygame.image.load('lab9/assets/blue.png').convert_alpha()
red_image = pygame.image.load('lab9/assets/red.png').convert_alpha()
green_image = pygame.image.load('lab9/assets/green.png').convert_alpha()
pink_image = pygame.image.load('lab9/assets/pink.png').convert_alpha()
eraser_image = pygame.image.load('lab9/assets/eraser.png').convert_alpha()
