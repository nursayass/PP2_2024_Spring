...
def main():
    ...
    # loading the images 
    clock_image = pygame.transform.scale(pygame.image.load('7lab/images/mickeyclock.jpeg'), (800, 600))
    sechand_image = pygame.image.load('7lab/images/sechand.png')
    sechand_image = pygame.transform.scale(sechand_image, (250, 75))
    sechand_rect = sechand_image.get_rect()
    sechand_rect.center = (400, 300)
    minhand_image = pygame.image.load('7lab/images/minhand.png')
