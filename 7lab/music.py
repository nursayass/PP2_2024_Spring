...
class SOUND:
    def __init__(self, path_to_sound, path_to_photo):
        self.sound = pg.mixer.Sound('7lab\music\\' + path_to_sound)
        self.photo = pg.image.load('7lab\\assets\\sound_images\\' + path_to_photo)
...
path_to_sound = os.listdir('7lab\\music\\')
path_to_photo = os.listdir('7lab\\assets\\sound_images\\')
path_to_sound.sort()
path_to_photo.sort()
...
BACKGROUD = pg.image.load('7lab\\assets\\bg.png').convert()
