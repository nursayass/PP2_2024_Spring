...
bg = pygame.image.load('8lab\\racer\\AnimatedStreet.png')

class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('8lab\\racer\\Enemy.png')
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('8lab\\racer\\Player.png')
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('8lab\\racer\\coin.png')
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40,w-40),0)
...
class Coin_2(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('8lab\\racer\\coin2.png')
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40,w-40),0)
