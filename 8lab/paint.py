...
def main():
    ...
    icon = pygame.image.load('8lab\\paint\\icon.jpg')
    ...
    brush_png = pygame.transform.scale(pygame.image.load("8lab\\paint\\brush.jpg"), (20,20))
    eraser_png = pygame.transform.scale(pygame.image.load("8lab\\paint\\eraser.jpg"), (20,20))
    clear_png = pygame.transform.scale(pygame.image.load("8lab\\paint\\Clear.png"), (30, 30))
    save_png = pygame.transform.scale(pygame.image.load("8lab\\paint\\save.png"), (98, 50))
    ...
    def size_buttons():
        ...
        sz_btn = pygame.transform.scale(pygame.image.load("8lab\\paint\\size.png"), (25, 25))
